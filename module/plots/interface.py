...
from module.registry import PLOTS
from module.plots import plot_kline
from module.plots import plot_trading
from module.utils import init_path
# from module.plots import plot_tsne_time_series
import shutil
...
class PlotsInterface():
    def __init__(self,
        ...
        self.tsne_plot_path = init_path(os.path.join(self.plot_path, "tsne"))
    ...
    def plot_trading(self, records, info, save_dir):
        ...
        return trading_path
    # def plot_TSNE(self, data, save_dir,suffix='jpeg'):
    #     try:
    #         tsne_dir = init_path(os.path.join(self.plot_path, "tsne"))
    #
    #         tsne_path = os.path.join(tsne_dir, "tsne_{}.{}".format(save_dir, suffix))
    #
    #         plot_tsne_time_series(data, save_path=tsne_path)
    #
    #     except Exception as e:
    #         print(e)
    #         tsne_path = None
