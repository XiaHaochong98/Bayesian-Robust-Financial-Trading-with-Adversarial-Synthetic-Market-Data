...
aapl = aapl_df.copy()
kf = apply_savgol_filter(aapl)
cut_savgo = create_augmented_data(aapl, kf, method='cut_mix')
binary_savgo = create_augmented_data(aapl, kf, method='binary_mix')
linear_savgo = create_augmented_data(aapl, kf, method='linear_mix')
geometric_savgo = create_augmented_data(aapl, kf, method='geometrix_mix')
amplitude_savgo = create_augmented_data(aapl, kf, method='amplitude_mix')
proposedmix_savgo = create_augmented_data(aapl, kf, method='proposed_mix')
...
augmented_datasets = {
    'original': aapl,
    'cut_mix': cut_savgo,
    'linear_mix': linear_savgo,
    'geometric_mix': geometric_savgo,
    'amplitude_mix': amplitude_savgo,
    'proposed_mix': proposedmix_savgo,
