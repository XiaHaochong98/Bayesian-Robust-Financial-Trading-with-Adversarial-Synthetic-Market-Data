...
aapl = aapl_df.copy()
kf = create_kalman_filters(aapl)
cut_kf = create_augmented_data(aapl, kf, method='cut_mix')
binary_kf = create_augmented_data(aapl, kf, method='binary_mix')
linear_kf = create_augmented_data(aapl, kf, method='linear_mix')
geometric_kf = create_augmented_data(aapl, kf, method='geometrix_mix')
amplitude_kf = create_augmented_data(aapl, kf, method='amplitude_mix')
proposedmix_kf = create_augmented_data(aapl, kf, method='proposed_mix')
...
augmented_datasets = {
    'original': aapl,
    'cut_mix': cut_kf,
    'linear_mix': linear_kf,
    'geometric_mix': geometric_kf,
    'amplitude_mix': amplitude_kf,
    'proposed_mix': proposedmix_kf,
