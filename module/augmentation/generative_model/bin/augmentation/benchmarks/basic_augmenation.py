# Implementation of the Paper: EVALUATING DATA AUGMENTATION FOR FINANCIAL TIME SERIES CLASSIFICATION
# Available at: https://arxiv.org/pdf/2010.15111.pdf
...
def scaling(x, sigma=0.1):
    ...
    factor = np.random.normal(
        loc=1.0, scale=sigma, size=(x.shape[0], x.shape[2])
    )
