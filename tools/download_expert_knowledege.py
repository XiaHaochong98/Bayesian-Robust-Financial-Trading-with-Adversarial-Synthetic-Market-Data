...
def parse_args():
    parser = argparse.ArgumentParser(description='Download expert knowledge')
    parser.add_argument("--config", default=os.path.join(ROOT, "configs", "downloader", "tools", "rapidapi_seekingalpha_analysis_exp.py"), help="download datasets config file path")
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
    ...
    parser.add_argument("--quota",type=int, default=5, help="download quota")
    parser.add_argument("--tool", type=str, default="seekingalpha_analysis")
